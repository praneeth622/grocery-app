      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Your one-stop shop for fresh, organic groceries delivered to your doorstep.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Organic Products</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Meal Kits</a></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Subscribe to our newsletter for weekly updates on new products and special offers.</p>
            <form className="flex flex-col sm:flex-row gap-2">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="min-w-0 flex-auto rounded-md border-0 bg-gray-700 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-500 sm:text-sm sm:leading-6"
        ...
        <div className="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">&copy; 2025 FreshMart. All rights reserved.</p>
